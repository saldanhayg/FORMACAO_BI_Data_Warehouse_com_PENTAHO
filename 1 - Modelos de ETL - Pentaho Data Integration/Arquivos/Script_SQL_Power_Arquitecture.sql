...
ALTER TABLE Dim_Categoria COMMENT 'Dimensão Produto';
...
ALTER TABLE Dim_Tempo COMMENT 'Descrição tempo';
...
CREATE TABLE Fato_005 (
                Cod_Produto NVARCHAR(50) NOT NULL,
                Cod_Temp NVARCHAR(50) NOT NULL,
                Cod_Fabrica NVARCHAR(50) NOT NULL,
                Meta_Custo DOUBLE PRECISION NOT NULL,
                PRIMARY KEY (Cod_Produto, Cod_Temp, Cod_Fabrica)
);
...
CREATE TABLE Fato_001 (
                ...
                PRIMARY KEY (Cod_Cliente, Cod_Produto, Cod_Organizacional, Cod_Fabrica, Cod_Tempo)
);
