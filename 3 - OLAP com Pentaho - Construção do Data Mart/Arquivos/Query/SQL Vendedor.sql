...
INNER JOIN DIM_ORGANIZACIONAL B ON A.COD_PAI = B.COD_ORGANIZACIONAL
INNER JOIN DIM_ORGANIZACIONAL C ON B.COD_PAI = C.COD_ORGANIZACIONAL
...
FROM DIM_ORGANIZACIONAL A 
INNER JOIN DIM_ORGANIZACIONAL B ON A.COD_PAI = B.COD_ORGANIZACIONAL
WHERE A.DIREITA - A.ESQUERDA = 1 AND B.COD_PAI = ''